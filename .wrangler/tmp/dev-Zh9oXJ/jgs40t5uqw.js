...
// .wrangler/tmp/pages-oey5ce/functionsWorker-0.4786671686937535.mjs
...
__name2(isSeeded, "isSeeded");
async function bootstrapOpen(env) {
  return !await isSeeded(env);
}
__name(bootstrapOpen, "bootstrapOpen");
__name2(bootstrapOpen, "bootstrapOpen");
var ALLOWED_ASSET_PREFIXES = ["books/", "orders/", "styles/", "og/"];
...
__name2(validAssetKey, "validAssetKey");
...
__name2(deleteAssetsWithPrefix, "deleteAssetsWithPrefix");
...
var onRequestPost2 = /* @__PURE__ */ __name2(async ({ env, request, params }) => {
  const rawId = Array.isArray(params.id) ? params.id[0] : params.id;
  ...
  const book = {
    ...
    ogUrl: typeof draft.ogUrl === "string" ? draft.ogUrl : void 0,
    createdAt: now,
    updatedAt: now
  };
  if (isUpdate) {
...
var onRequestGet6 = /* @__PURE__ */ __name2(async ({ env, params, request }) => {
  const slug = Array.isArray(params.slug) ? params.slug[0] : params.slug;
  if (!slug) return env.ASSETS.fetch(request);
  const row = await env.DB.prepare("SELECT data FROM books WHERE id = ?").bind(slug).first();
  ...
  const injected = html.replace(/<title>[^<]*<\/title>/, `<title>${title} \xB7 Wonder Pages</title>`).replace(
    "</head>",
    [
...
// ../../Users/digim/AppData/Roaming/npm/node_modules/wrangler/templates/pages-dev-util.ts
...
// .wrangler/tmp/pages-oey5ce/jgs40t5uqw.js
...
// ../../Users/digim/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-ensure-req-body-drained.ts
...
// ../../Users/digim/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/middleware-miniflare3-json-error.ts
...
// .wrangler/tmp/bundle-eBc8TY/middleware-insertion-facade.js
...
// ../../Users/digim/AppData/Roaming/npm/node_modules/wrangler/templates/middleware/common.ts
...
// .wrangler/tmp/bundle-eBc8TY/middleware-loader.entry.ts
